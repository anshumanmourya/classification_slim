...
#change jpg here , alos change the depth
...
#see whether to make any changes
...
#make changes here in jpg, change data[i] according to format in .txt file, check whether centre is given or something else
